...
image_test_folder = '/content/drive/My Drive/Colab/TestingData/'

#detection_results_folder = os.path.join(image_folder, "Test_Image_Detection_Results")
#detection_results_file = os.path.join(detection_results_folder, "Detection_Results.csv")
detection_results_folder = "/content/drive/My Drive/Colab/Results/"
detection_results_file = "/content/drive/My Drive/Colab/Results/Detection_Results.csv"

#model_folder = os.path.join(data_folder, "Model_Weights")
#model_weights = os.path.join(model_folder, "trained_weights_final.h5")
#model_classes = os.path.join(model_folder, "data_classes.txt")
model_weights = '/content/drive/My Drive/Colab/trained_weights_final.h5'
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        dest="postfix",
        default="_damage",
        help='Specify the postfix for images with bounding boxes. Default is "_damage"',
    )
